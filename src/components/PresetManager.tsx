...
import { Trash2, Copy, ArrowRight, Download, Upload, Settings } from 'lucide-react';
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground">
                    ${preset.cost}+${preset.fee} → ${preset.price}
                    {preset.isSystem && ' (系統)'}
                  </div>
                </div>
                <button
                ...
                >
                  <Trash2 className={`w-4 h-4 ${
                    deleteConfirmId === preset.id ? '' : 'text-muted-foreground'
                  }`} />
                </button>
              </div>
            ))}
